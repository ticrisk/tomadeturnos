...
@section('content')
    ...
    <section>
        <div class="container">
            ...
            <h4 class="text-center">Cantidad de Turnos Asignados</h4>
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                    {!!  Form::open(array('route' => array('admin.local.cantidad-turnos-asignados', $id),'method' => 'GET')) !!}
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <a href="{{ url('admin/local/'.$id.'/opciones') }}" class="btn btn-success  btn-sm"  data-toggle="tooltip" title="Opciones">Regresar</a>
                        </div>
                    </div>
