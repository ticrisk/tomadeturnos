...
@section('content')
    <section>
        <div class="container">
            ...
            <h4 class="text-center">Detalle Cobro Mensual</h4>
            ...
            <div class="card card-primary">
                ...
                <div class="card-block">
                    ...
                    @foreach($infoUsers as $infoUser)
                        <div class="row p-t-5">
                            ...
                            <div class="col-12 col-sm-12 col-md-2 text-center">
                                ...
                                {!! Form::open(['route' => 'admin.local.detalle-turnos-tomados', 'method' => 'GET']) !!}
                    ...
                    <div class="text-center">
                        <a href="{{ url('admin/local/'.$local.'/pago-encargado') }}" class="btn btn-primary  btn-sm "  data-toggle="tooltip" title="Volver">Volver</a>
                    </div>
