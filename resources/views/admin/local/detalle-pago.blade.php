                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-6 col-md-6 text-right">
                            {!! Form::open(['route' => ['admin.local.deletePago', $pago->id], 'method' => 'DELETE']) !!}
                                <button type="submit" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Eliminar" onclick="return confirm('¿Está seguro que desea eliminar el pago?.')">Borrar</button>
                            {!! Form::close() !!}
                        </div>
