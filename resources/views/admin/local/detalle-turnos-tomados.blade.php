...
@section('content')
    <section>
        <div class="container">
            ...
            <h4 class="text-center">Turnos Tomados</h4>
            ...
            <div class="card card-primary">
                ...
                <div class="card-block">
                    ...
                    <div class="text-center">
                        <a href="{{ url('admin/local/detalle-cobro-mensual?local='.$request->local.'&fecha='.$request->fecha) }}" class="btn btn-primary  btn-sm "  data-toggle="tooltip" title="Volver">Volver</a>
                    </div>
                </div>
            </div>
        </div>
