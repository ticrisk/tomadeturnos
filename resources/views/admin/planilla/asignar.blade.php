...
@include('admin/planilla/modal/actualizar-usuario-turno')
...
<div class="container">
    ...
    <div class="card card-info">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['action' => 'AdminController@postAsignar', 'method' => 'POST']) !!}
    ...
    <div class="card card-primary">
        ...
        {!! Form::open(['route' => ['admin.planilla.deleteUsuarioTurno', ':Turno_ID'], 'method' => 'DELETE', 'id'=>'form-delete'])!!}
{!! Form::close() !!}
...
@section('js')
 <script type="text/javascript">
    ...
    function mostrar(btn){
      //alert(btn.value);
      var route = "{{ asset('/admin/planilla/turnoUser/') }}"+btn.value+"";
  ...
  $("#actualizar").click(function(){
    ...
    $.ajax({
      ...
      type: 'PUT',
      dataType: 'json',
      data: {info: id,coordinador,fijo,tipo,estado,deseo,exTipo,planilla_id,turno_id,local_user_id},//genre:
      /**/
      success: function(){
        //Carga();
