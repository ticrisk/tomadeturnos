            ...
            <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                  ...
                                  <a href="{{ url('admin/planilla/'.$planilla->id.'/disponible') }}" class="btn btn-sm btn-success">Disponible</a>
                                </div>
                            </div>
                            ...
                            <div class="alert alert-info" role="alert">
                                ...
                                <br>
                                <strong>** </strong> Los números que aparecen en parentesis al lado de cada hora de los turnos son el máximo de cupos permitidos.
                                <br>
                                <strong>** </strong> "Turno Error" indican que se excedió la cantidad permitida de empaques que van asisitir al turno en la Planilla. Ej: Si un turno permite solo 4 empaques y por error del sistema tomarón 5 (que es difícil que suceda) la página muestra un mensaje de alerta. Cabe destacar que el primero en la lista es el dueño del turno.
                            </div>
            </div>
        </div>
    </div>
