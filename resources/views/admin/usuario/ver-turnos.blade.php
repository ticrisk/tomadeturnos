        ...
        <div class="container">
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                    ...
                    {!!  Form::open(array('route' => array('admin.usuario.ver-turnos', $usuario->id),'method' => 'GET')) !!}
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="col-lg-12 text-center">
                        <a href="{{ url('admin/local/'.$usuario->local_id.'/empaques') }}" class="btn btn-sm btn-primary">Volver</a>
                    </div>
