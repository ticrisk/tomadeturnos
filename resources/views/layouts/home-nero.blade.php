...
<header id="header">
    <div class="container">
        <div class="navbar-backdrop">
            <div class="navbar">
                <div class="navbar-left dropdown-profile"><!--  dropdown-profile -->
                    <a class="navbar-toggle"><i class="fa fa-bars"></i></a>
                    <a href="/" class="logo"><img src="{{ asset('img/perfil-proyecto-nero.jpg') }}" alt="img-avatar"></a>
                    {{--<a href="/" class="logo"><img src="{{ asset('img/logo2.png') }}" alt="logo-casablanca"></a> --}}<!--img/logo-toma-de-turnos.png-->
                    <nav class="nav">
                        <ul>
