...
<section>
    <div class="container"><!-- -fluid -->
        ...
        <div class="hidden-md-up text-center m-b-15"><b><u><a href="{{ url('turno/pre-toma-por-dia/'.$planilla->local_id) }}">Vista por día</a></u></b> - <b><u><a href="{{ url('turno/pre-toma/'.$planilla->local_id) }}">Vista Normal</a></u></b></div>
    ...
    <div class="container hidden-sm-down">
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="text-center"><b><u><a href="{{ url('turno/pre-toma/'.$planilla->local_id) }}">Ir a Vista Normal</a></u></b></div>
            </div>
        </div>
    </div>
    <div class="container-fluid hidden-md-up">
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                @else
                <div class="row"> @include('turno/incluir/turnos-pre-toma-2x4') </div>
                @endif
