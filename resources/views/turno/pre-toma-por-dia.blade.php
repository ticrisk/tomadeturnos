...
@section('content')
    <section>
        <div class="container"><!-- -fluid -->
            ...
            <div class="hidden-md-up text-center m-b-15"><b><u><a href="{{ url('turno/pre-toma-2x4/'.$planilla->local_id) }}">Vista 2x4</a></u></b> - <b><u><a href="{{ url('turno/pre-toma/'.$planilla->local_id) }}">Vista Normal</a></u></b></div>
        ...
        @else
            <div class="hidden-md-up"> @include('turno/incluir/turnos-pre-toma-por-dia') </div>
        @endif
