...
<section>
    <div class="container"><!-- -fluid -->
        ...
        <div class="hidden-md-up text-center m-b-15"><b><u><a href="{{ url('turno/toma-por-dia/'.$planilla->local_id) }}">Vista por día</a></u></b> - <b><u><a href="{{ url('turno/toma-2x4/'.$planilla->local_id) }}">Vista 2x4</a></u></b></div>
    ...
    <div class="container-fluid">
        <div class="card card-primary">
            ...
            <div class="card-body">
                    ...
                    @else
                      <div class="row"> @include('turno/incluir/turnos-toma-pc') </div>
                    @endif
