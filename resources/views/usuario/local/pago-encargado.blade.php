...
@section('content')
    <section>
        <div class="container">
            ...
            <h4 class="text-center">Pagos del Encargado  <i class="fa fa-star text-warning pull-right" aria-hidden="true" data-toggle="tooltip" title="Opción Premium"></i></h4>
            ...
            <div class="card card-primary">
                ...
                <div class="card-block">
                    ...
                    {!! Form::open(['route' => 'usuario.local.detalle-cobro-mensual', 'method' => 'GET']) !!}
