    ...
    <div class="container">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['action' => 'UsuarioController@postCrearPlanilla', 'method' => 'POST']) !!}
                ...
                <div class="row form-group">
                    <div class="col-md-12 text-center">
                        ...
                        <a href="{{ url('usuario/ver-locales') }}" class="btn btn-primary btn-sm"  data-toggle="tooltip" title="Opciones">Regresar</a>
                    </div>
                </div>
