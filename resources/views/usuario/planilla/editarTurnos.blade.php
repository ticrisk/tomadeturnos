    ...
    <section>
        <div class="container">
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                    {!! Form::open(['action' => 'UsuarioController@postAgregarTurno', 'method' => 'POST']) !!}
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var listTurn = function()
        {
            ...
            $.ajax({
                type:'get',
                url:"{{url('usuario/planilla')}}/"+id+"/listTurn",
        ...
        {
            //alert(id);
            var route = "{{url('usuario/planilla')}}/"+id+"/infoTurno";
        ...
        $("#actualizar").click(function()
        {
            ...
            var route = "{{url('usuario/planilla')}}/"+id+"/updateTurno";
            var token = $("#token").val();
        ...
        {
            var route = "{{url('usuario/planilla')}}/"+id+"/deleteTurno";
            var token = $("#token").val();
